...
function init() {
  ...
  ReactDOM.createRoot(div).render(/*#__PURE__*/React.createElement(DataGeneratorForm, null));
}
...
class DataGeneratorForm extends React.Component {
  ...
  render() {
    return (/*#__PURE__*/
      ...
      React.createElement("label", null, "Number of items"), /*#__PURE__*/
      React.createElement("input", { type: "number", min: 1,
        onChange: (e) => this.setState({ numItems: e.target.value }),
        value: this.state.numItems })
      ), /*#__PURE__*/
      React.createElement("p", null, /*#__PURE__*/
      React.createElement("label", null, "Items per transaction"), /*#__PURE__*/
      React.createElement("input", { type: "number", min: 10,
        onChange: (e) => this.setState({ chunkSize: e.target.value }),
        value: this.state.chunkSize })
      ), /*#__PURE__*/
      React.createElement("p", null, /*#__PURE__*/
      React.createElement("label", null, "Number of collections"), /*#__PURE__*/
      ...
      React.createElement("p", null, /*#__PURE__*/
      React.createElement("input", { type: "submit", onClick: (_) => generateData(this.state) })
      )
      ));
