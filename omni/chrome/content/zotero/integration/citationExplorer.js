...
const citationColumns = [
{
  dataKey: 'isLinked',
  label: 'Is Linked',
  iconLabel: /*#__PURE__*/React.createElement(IconAttachSmall, null),
  width: 26,
  staticWidth: true,
  fixedWidth: true,
  ...
  refreshCitationList: async function () {
    ...
    if (!citationList) {
      await new Promise((resolve) => {
        ReactDOM.createRoot(document.querySelector('#citation-list')).render(/*#__PURE__*/React.createElement(VirtualizedTable, {
          id: "citation-list",
          ref: (ref) => {
            citationList = ref;
            resolve();
