...
var _icons = require("components/icons"); /*
    ...
    ***** END LICENSE BLOCK *****
*/window.isPristine = true;var Zotero_Bibliography_Dialog = new function () {var bibEditInterface;var _lastSelectedItemID = false;var _lastSelectedIndex = false;var _lastSelectedValue = false;var _accepted = false;var _revertButton, _revertAllButton, _addButton, _removeButton;var _itemList;var _editor;var _suppressAllSelectEvents = false; /**
   * Initializes add citation dialog
   */this.load = async function () {bibEditInterface = window.arguments[0].wrappedJSObject;_revertAllButton = document.querySelector('dialog').getButton("extra2");_revertButton = document.querySelector('dialog').getButton("extra1");_addButton = document.getElementById("add");_removeButton = document.getElementById("remove");_itemList = document.getElementById("item-list");
  ...
  function _loadItems() {
    ...
    for (var i = 0; i < items.length; i++) {
      ...
      let image = (0, _icons.getCSSItemTypeIcon)(items[i].getItemTypeIconName());
