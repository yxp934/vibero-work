...
class TagList extends React.PureComponent {
  ...
  renderTag = ({ index, _key, style }) => {
    ...
    return (/*#__PURE__*/
      React.createElement("div", _extends({ key: tag.name }, props), /*#__PURE__*/
  ...
  render() {
    ...
    if (!this.props.loaded) {
      tagList = /*#__PURE__*/
      React.createElement("div", { className: "tag-selector-message" },
    ...
    return (/*#__PURE__*/
      React.createElement("div", { className: "tag-selector-list-container", onKeyDown: this.handleKeyDown.bind(this) },
      tagList
      ));
