...
var _immutable = require("zotero/modules/immutable");

var _reactAutosuggest = require("react-autosuggest");var _reactAutosuggest2 = _interopRequireDefault(_reactAutosuggest);function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}function _extends() {return _extends = Object.assign ? Object.assign.bind() : function (n) {for (var e = 1; e < arguments.length; e++) {var t = arguments[e];for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]);}return n;}, _extends.apply(null, arguments);} /*
    ***** BEGIN LICENSE BLOCK *****
...
class Input extends _react2.default.PureComponent {constructor(props) {super(props);this.state = { suggestions: [], value: props.value };this.suggestions = /*#__PURE__*/_react2.default.createRef();this.showSuggestions = /*#__PURE__*/_react2.default.createRef(false);this.preSuggestionValue = /*#__PURE__*/_react2.default.createRef();this.selectedSuggestion = /*#__PURE__*/_react2.default.createRef();}cancel(event = null) {this.props.onCancel(this.hasChanged, event);this.hasBeenCancelled = true;this.props.innerRef.current && this.props.innerRef.current.blur();}commit(event = null) {this.props.onCommit(this.state.value, this.hasChanged, event);this.hasBeenCommitted = true;}
  ...
  renderSuggestion(suggestion) {
    return /*#__PURE__*/_react2.default.createElement("span", null,
    suggestion
    );
  }
  ...
  renderInput() {
    ...
    var input = this.props.autoComplete ? /*#__PURE__*/
    _react2.default.createElement(_reactAutosuggest2.default, {
      ...
      , renderInputComponent: (inputProps) => /*#__PURE__*/_react2.default.createElement("input", _extends({}, inputProps, { ref: this.props.innerRef })),
    ...
    if (this.props.resize) {
      ...
      );*/}return input;}render() {const className = (0, _classnames2.default)({ 'input-group': true,
        'input': true,
...
_react2.default.forwardRef((props, ref) => /*#__PURE__*/_react2.default.createElement(Input, _extends({
  innerRef: ref }, props)
));