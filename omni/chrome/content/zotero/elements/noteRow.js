  ...
  class NoteRow extends XULElementBase {
    ...
    render() {
      ...
      if (note.parentItemType) {
        this.querySelector('.icon').replaceWith((0, _icons.getCSSItemTypeIcon)(note.parentItemType));
      ...
      {
        this.querySelector('.icon').replaceWith((0, _icons.getCSSItemTypeIcon)('note'));
