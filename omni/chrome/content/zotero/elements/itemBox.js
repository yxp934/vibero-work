    ...
    */
    ...
    _renderInternal() {
      ...
      for (let fieldName of fieldNames) {
        ...
        if (fieldName == 'DOI' && val && typeof val == 'string') {
      ...
      if (this.editable && Zotero.CreatorTypes.itemTypeHasCreators(this.item.itemTypeID)) {
        // Add default row
    ...
    moveCreator(index, dir, newIndex, skipSave) {
      ...
      if (index + 1 == this.item.numCreators() && dir == 'down') {
