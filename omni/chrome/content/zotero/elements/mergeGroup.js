...
var _reactDom = require("react-dom");var _reactDom2 = _interopRequireDefault(_reactDom);function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };} /*
    ...
    ***** END LICENSE BLOCK *****
*/{class MergeGroup extends XULElement {constructor() {super();this.libraryID = null;this._data = null;this._type = null;this.content = MozXULElement.parseXULToFragment(`
			...
			`, ['chrome://zotero/locale/zotero.dtd']);}get stylesheets() {return ['chrome://zotero/skin/merge.css'];}connectedCallback() {this.append(document.importNode(this.content, true));this._leftPane = this._id('left-pane');
      ...
      this.addEventListener('keypress', (event) => {
        ...
        if (event.key == Zotero.arrowPreviousKey && !this._leftPane.hasAttribute("selected")) {
  ...
  class MergePane extends XULElement {
    ...
    set data(val) {
      ...
      if (item.isAnnotation()) {
        ...
        then((data) => {
          this._objboxRoot = _reactDom2.default.createRoot(objbox);
