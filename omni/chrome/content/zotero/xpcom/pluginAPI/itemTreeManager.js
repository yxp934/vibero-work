...
var _itemTreeColumns = require("zotero/itemTreeColumns"); /*
	***** BEGIN LICENSE BLOCK *****
...
*/{const PluginAPIBase = ChromeUtils.importESModule("chrome://zotero/content/xpcom/pluginAPI/pluginAPIBase.mjs").PluginAPIBase; /**
   ...
   */class ItemTreeColumnManagerInternal extends PluginAPIBase {constructor() {super();this.config = { apiName: "ItemTreeColumnManager", mainKeyName: "dataKey", notifyType: "itemtree", optionTypeDefinition: { dataKey: "string", label: "string", pluginID: "string", enabledTreeIDs: { type: "array", optional: true
          },
          defaultIn: {
            type: "array",
            optional: true,
    ...
    _validate(option) {
      ...
      if (_itemTreeColumns.COLUMNS.find((col) => col.dataKey === mainKey)) {
