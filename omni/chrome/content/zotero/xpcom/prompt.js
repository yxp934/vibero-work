...
Zotero.Prompt = {
  ...
  confirm(options = {}) {
    ...
    if (typeof button0 == 'number') flags += Services.prompt.BUTTON_POS_0 * button0;else
    if (typeof button0 == 'string') flags += Services.prompt.BUTTON_POS_0 * Services.prompt.BUTTON_TITLE_IS_STRING;
    if (typeof button1 == 'number') flags += Services.prompt.BUTTON_POS_1 * button1;else
    if (typeof button1 == 'string') flags += Services.prompt.BUTTON_POS_1 * Services.prompt.BUTTON_TITLE_IS_STRING;
    if (typeof button2 == 'number') flags += Services.prompt.BUTTON_POS_2 * button2;else
    if (typeof button2 == 'string') flags += Services.prompt.BUTTON_POS_2 * Services.prompt.BUTTON_TITLE_IS_STRING;
