   ...
   */    printWarning = function(text) {
    ...
    function scrollbarSize(recalc) {
        if ((!size && 0 !== size || recalc) && canUseDOM) {
            ...
            scrollDiv.style.height = "50px", scrollDiv.style.overflow = "scroll", document.documentElement.appendChild(scrollDiv), 
            size = scrollDiv.offsetWidth - scrollDiv.clientWidth, document.documentElement.removeChild(scrollDiv);
        }
        return size;
    }
            ...
            _defineProperty(_assertThisInitialized(_this), "_invokeOnSectionRenderedHelper", function() {
                ...
                if (event.target === _this._scrollingContainer) {
                    ...
                    if (_this.state.scrollLeft !== scrollLeft || _this.state.scrollTop !== scrollTop) {
                        ...
                        _this.state.isScrolling || isScrollingChange(!0), ReactDOM.flushSync(() => _this.setState({
                            isScrolling: !0,
                            scrollLeft: scrollLeft,
